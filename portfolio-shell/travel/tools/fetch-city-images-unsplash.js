...
const EN = {
  ...
  뉴욕: "New York City", 로스앤젤레스: "Los Angeles", 라스베이거스: "Las Vegas",
  파리: "Paris France", 로마: "Rome Italy", 바르셀로나: "Barcelona",
  런던: "London", 에든버러: "Edinburgh", 맨체스터: "Manchester UK",
  밴쿠버: "Vancouver", 토론토: "Toronto", 몬트리올: "Montreal",
  시드니: "Sydney", 멜버른: "Melbourne", 골드코스트: "Gold Coast Australia",
  오클랜드: "Auckland New Zealand", 퀸스타운: "Queenstown New Zealand", 웰링턴: "Wellington New Zealand",
  스톡홀름: "Stockholm", 예테보리: "Gothenburg", 말뫼: "Malmo",
  오슬로: "Oslo", 베르겐: "Bergen Norway", 트롬쇠: "Tromso",
  코펜하겐: "Copenhagen", 오르후스: "Aarhus", 오덴세: "Odense",
  칸쿤: "Cancun", 멕시코시티: "Mexico City", 과달라하라: "Guadalajara",
  델리: "New Delhi", 뭄바이: "Mumbai", 자이푸르: "Jaipur",
  리우데자네이루: "Rio de Janeiro", 상파울루: "Sao Paulo", 살바도르: "Salvador Brazil",
  케이프타운: "Cape Town", 요하네스버그: "Johannesburg", 더반: "Durban",
  바르샤바: "Warsaw", 크라쿠프: "Krakow", 그단스크: "Gdansk",
  프라하: "Prague", 체스키크룸로프: "Cesky Krumlov", 브르노: "Brno",
  부다페스트: "Budapest", 데브레첸: "Debrecen", 세게드: "Szeged",
  예루살렘: "Jerusalem", 텔아비브: "Tel Aviv", 하이파: "Haifa Israel",
  부쿠레슈티: "Bucharest", 브라쇼브: "Brasov", 시비우: "Sibiu",
};
