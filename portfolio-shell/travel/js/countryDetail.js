...
//   foods : 대표 먹거리 3개 { name, price } — price는 현지 한 끼/1개 대략 가격(원 환산 근사)
//   tips  : 여행 꿀팁 3개  { cat, title, text }
const COUNTRY_DETAIL = {
  jp: {
    cities: [{ name: "도쿄", index: -14 }, { name: "오사카", index: -18 }, { name: "후쿠오카", index: -20 }],
    foods: [{ name: "스시", price: 12000 }, { name: "라멘", price: 8500 }, { name: "규카츠", price: 14000 }],
    tips: [
  ...
  vn: {
    ...
    foods: [{ name: "쌀국수", price: 3000 }, { name: "반미", price: 2500 }, { name: "분짜", price: 4000 }],
    tips: [
      { cat: "환전", title: "환전", text: "달러 환전 후 현지 금은방 환전이 환율 유리." },
      { cat: "교통", title: "교통", text: "그랩(Grab) 앱으로 택시·오토바이 정찰제 이용." },
      { cat: "치안", title: "소매치기", text: "오토바이 날치기 주의 — 가방은 안쪽으로." },
    ],
  },
  th: {
    cities: [{ name: "방콕", index: -38 }, { name: "치앙마이", index: -44 }, { name: "푸껫", index: -30 }],
    foods: [{ name: "팟타이", price: 3500 }, { name: "똠얌꿍", price: 6000 }, { name: "망고밥", price: 4000 }],
    tips: [
  ...
  sg: {
    ...
    foods: [{ name: "치킨라이스", price: 6000 }, { name: "칠리크랩", price: 45000 }, { name: "락사", price: 7000 }],
    tips: [
      { cat: "먹거리", title: "호커센터", text: "호커센터는 물가 높은 싱가포르에서 가성비 최고." },
      { cat: "교통", title: "교통", text: "EZ-Link 카드로 MRT·버스, 도보 이동도 편리." },
      { cat: "주의", title: "벌금", text: "지하철 취식·껌·무단횡단 벌금 주의." },
    ],
  },
  hk: {
    cities: [{ name: "홍콩섬", index: 4 }, { name: "구룡", index: -2 }, { name: "마카오", index: -6 }],
    foods: [{ name: "딤섬", price: 9000 }, { name: "완탕면", price: 7000 }, { name: "에그타르트", price: 2500 }],
    tips: [
      { cat: "교통", title: "교통", text: "옥토퍼스 카드로 MTR·트램·페리·편의점 결제." },
      { cat: "먹거리", title: "차찬텡", text: "현지 차찬텡(홍콩식 분식)이 저렴하고 든든." },
      { cat: "쇼핑", title: "쇼핑", text: "몽콕 야시장 흥정, 명품은 세금 없어 유리." },
    ],
  },
  cn: {
    cities: [{ name: "상하이", index: -8 }, { name: "베이징", index: -12 }, { name: "청두", index: -22 }],
    foods: [{ name: "훠궈", price: 12000 }, { name: "샤오롱바오", price: 6000 }, { name: "베이징덕", price: 20000 }],
    tips: [
      { cat: "결제", title: "결제", text: "알리페이·위챗페이 필수(외국인 카드 등록 가능)." },
      { cat: "인터넷", title: "VPN", text: "구글·인스타 차단 — 로밍 또는 VPN 미리 준비." },
      { cat: "교통", title: "교통", text: "디디(DiDi) 앱으로 택시, 고속철(가오톄) 편리." },
    ],
  },
  my: {
    cities: [{ name: "쿠알라룸푸르", index: -30 }, { name: "코타키나발루", index: -34 }, { name: "페낭", index: -36 }],
    foods: [{ name: "나시르막", price: 3500 }, { name: "락사", price: 5000 }, { name: "사테", price: 4500 }],
    tips: [
